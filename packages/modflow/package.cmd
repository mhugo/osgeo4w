...
tar --transform 's,mt3dms/,,' -rvf tmp.tar mt3dms/bin/mt3dms5b.exe mt3dms/bin/mt3dms5s.exe
tar --transform 's,mt3d-usgs_Distribution/,,' -rvf tmp.tar mt3d-usgs_Distribution/bin/MT3D-USGS_64.exe
